...
//!
//! Identity is pinned. Script closure is not. Remaining parts stay fail-closed
//! until the five absent active scripts and two path-placement variants are
//! recovered or independently reconstructed with provenance.
