...
test "the registered 1601EQ package reports its printed identity and is not identity-ready" {
    ...
    try std.testing.expect(form_1601eq_2018.interaction.validate_lock_ready);
    try std.testing.expect(form_1601eq_2018.interaction.computation_reset_ready);
    ...
    try std.testing.expect(form_1601eq_2018.validation.atc_entry_gate_ready);
