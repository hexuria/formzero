...
- Native input controls inventoried: 392
...
| 1601EQ | Quarterly Remittance Return of Creditable Income Taxes Withheld (Expanded) | withholding_tax | 2018-01-ENCS | static_layout | no_setup | — | quarterly | 1-4 | 66 | 0 | src/pages/forms/1601-eq.native |
...
| 1601EQ 2018-01-ENCS | no_setup | 1 | `00da4f31d7e8646a51315909b4eadf20feaf1bd8b7d8127158bf0475bed3be1a` | 0 | 0 | 0 | Identity, filing choices, unbound ATC rows, remittance totals, payment rows, and tax-agent fields; save stays disabled until an exact 1601EQ path exists |
...
| `1601EQ.2018-01-ENCS.input.tax_agent_accreditation_attorney_roll_no` | Tax Agent Accreditation / Attorney Roll No. | external | — | — | — | — | preparer | text | unbound_input | `src/pages/forms/1601-eq.native:69` |
| `1601EQ.2018-01-ENCS.input.date_issued` | Date Issued | external | — | — | — | — | evidence | date | unbound_input | `src/pages/forms/1601-eq.native:70` |
| `1601EQ.2018-01-ENCS.input.date_of_expiry` | Date of Expiry | external | — | — | — | — | evidence | date | unbound_input | `src/pages/forms/1601-eq.native:71` |
| `1601EQ.2018-01-ENCS.input.item_33_agency` | Item 33 agency | external | — | — | — | — | payment | text | unbound_input | `src/pages/forms/1601-eq.native:80` |
| `1601EQ.2018-01-ENCS.input.item_33_date_paid` | Item 33 date paid | external | — | — | — | — | payment | date | unbound_input | `src/pages/forms/1601-eq.native:81` |
| `1601EQ.2018-01-ENCS.input.item_33_number` | Item 33 number | external | — | — | — | — | payment | text | unbound_input | `src/pages/forms/1601-eq.native:82` |
| `1601EQ.2018-01-ENCS.input.item_33_amount` | Item 33 amount | external | — | — | — | — | payment | money | unbound_input | `src/pages/forms/1601-eq.native:83` |
| `1601EQ.2018-01-ENCS.input.item_34_agency` | Item 34 agency | external | — | — | — | — | payment | text | unbound_input | `src/pages/forms/1601-eq.native:89` |
| `1601EQ.2018-01-ENCS.input.item_34_date_paid` | Item 34 date paid | external | — | — | — | — | payment | date | unbound_input | `src/pages/forms/1601-eq.native:90` |
| `1601EQ.2018-01-ENCS.input.item_34_number` | Item 34 number | external | — | — | — | — | payment | text | unbound_input | `src/pages/forms/1601-eq.native:91` |
| `1601EQ.2018-01-ENCS.input.item_34_amount` | Item 34 amount | external | — | — | — | — | payment | money | unbound_input | `src/pages/forms/1601-eq.native:92` |
| `1601EQ.2018-01-ENCS.input.item_35_agency` | Item 35 agency | external | — | — | — | — | payment | text | unbound_input | `src/pages/forms/1601-eq.native:98` |
| `1601EQ.2018-01-ENCS.input.item_35_date_paid` | Item 35 date paid | external | — | — | — | — | payment | date | unbound_input | `src/pages/forms/1601-eq.native:99` |
| `1601EQ.2018-01-ENCS.input.item_35_number` | Item 35 number | external | — | — | — | — | payment | text | unbound_input | `src/pages/forms/1601-eq.native:100` |
| `1601EQ.2018-01-ENCS.input.item_35_amount` | Item 35 amount | external | — | — | — | — | payment | money | unbound_input | `src/pages/forms/1601-eq.native:101` |
| `1601EQ.2018-01-ENCS.input.item_36_agency` | Item 36 agency | external | — | — | — | — | payment | text | unbound_input | `src/pages/forms/1601-eq.native:107` |
| `1601EQ.2018-01-ENCS.input.item_36_date_paid` | Item 36 date paid | external | — | — | — | — | payment | date | unbound_input | `src/pages/forms/1601-eq.native:108` |
| `1601EQ.2018-01-ENCS.input.item_36_number` | Item 36 number | external | — | — | — | — | payment | text | unbound_input | `src/pages/forms/1601-eq.native:109` |
| `1601EQ.2018-01-ENCS.input.item_36_amount` | Item 36 amount | external | — | — | — | — | payment | money | unbound_input | `src/pages/forms/1601-eq.native:110` |
| `1601EQ.2018-01-ENCS.input.item_36_particular` | Item 36 particular | external | — | — | — | — | payment | text | unbound_input | `src/pages/forms/1601-eq.native:111` |
