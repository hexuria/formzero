...
- Native input controls inventoried: 325
- Meaningful static-table fields inventoried: 63
- Direct profile projection targets: 91
- Optional profile projection targets: 34
- Visible taxpayer-year setting targets: 2
- Taxpayer-year consumer forms: 3
- Declared taxpayer-year setting consumptions: 5
- Fixed form-policy targets: 4
- Nonempty Tax Form Profile setup contracts: 7
- Explicit `no_setup` editor contracts: 3
- Tax Form Profile semantic values: 12
- Evidence-required (unsupported) setup values: 5
...
| 1601C | Monthly Remittance Return of Income Taxes Withheld on Compensation | withholding_tax | 2018-01-ENCS | static_layout | setup | — | monthly | 1-12 | 30 | 7 | src/pages/forms/1601-c.native |
...
| 0619F | Monthly Remittance Form for Final Income Taxes Withheld | withholding_tax | 2018-01-ENCS | static_layout | setup | — | monthly | 1-12 | 25 | 4 | src/pages/forms/0619-f.native |
...
| 1702RT | Annual Income Tax Return — Regular Taxable | income_tax | 2018-01-ENCS | static_layout | setup | — | annual | — | 36 | 3 | src/pages/forms/1702-rt.native |
...
| 2550Q | Quarterly Value-Added Tax Return | value_added_tax | 2024-04-ENCS | static_layout | no_setup | — | quarterly | 1-4 | 37 | 13 | src/pages/forms/2550q.native |
| 2551Q | Quarterly Percentage Tax Return | percentage_tax | 2018-01-ENCS | static_layout | no_setup | `income_tax_rate_election` | quarterly | 1-4 | 35 | 4 | src/pages/forms/2551q.native |
...
| 0619E | Monthly Remittance Form for Creditable Income Taxes Withheld (Expanded) | withholding_tax | 2018-01-ENCS | static_layout | setup | — | monthly | 1-12 | 24 | 4 | src/pages/forms/0619-e.native |
...
| 2551Q 2018-01-ENCS | `income_tax_rate_election` | 1 |
...
| 1601C 2018-01-ENCS | setup | 1 | `179583271c63f97aec9c68ded56403efd5236fa6103641c8fc6a96e1cf64b3c7` | 1 | 1 | 0 | Ownership matrix § 1601C |
| 0619F 2018-01-ENCS | setup | 1 | `93ab4ef44d1e44b712de233088c94eba8e37bf6f282ffff6621ab34e1869edb4` | 1 | 0 | 1 | Ownership matrix § 0619F |
| 1701Q 2018-01-ENCS | setup | 2 | `3b4d5c84fe96cb99cb422b4d98554359ccd45ea64ba2ae5cdd21c7325cb00abf` | 3 | 2 | 1 | Ownership matrix § 1701Q |
| 1701 2018-01-ENCS | setup | 2 | `1bb153eff6506090b118fc67e6fd23e8d63d8d654cb147fe0a43b7926b3f7b16` | 3 | 2 | 1 | Ownership matrix § 1701 |
| 1702RT 2018-01-ENCS | setup | 1 | `02592c75d72d118e68baac2e5be1d3d43deacad0f6eaa27f8ad390e6cc03c382` | 1 | 1 | 0 | Ownership matrix § 1702RT |
| 1702MX 2018-01-ENCS | setup | 1 | `28d601fbdc840c0d6aa8768f0ae00b69288e4ae96aca9d4c496fab5b00730936` | 2 | 1 | 1 | Ownership matrix § 1702MX |
...
| 2551Q 2018-01-ENCS | no_setup | 1 | `d87f1c08a0bc104cf70d4e90cba96b155af614c75ad2a1bcb6be0803fa322eec` | 0 | 0 | 0 | Architecture § 2551Q boundary and ownership matrix § 2551Q keep the inherited header, taxpayer-year election, and Schedule 1 out of annual setup |
| 0619E 2018-01-ENCS | setup | 1 | `ed15f9eb1fdfa15af53d594adc4ad406d6d9a546f259b817066b91c1eb32cc0f` | 1 | 0 | 1 | Ownership matrix § 0619E |
...
|---|---|---|---|---|---|---|---|---|---|---|
| 1601C 2018-01-ENCS | `business_activity_anchor_id` | business_activity_anchor_id | filer | conditional | effective_business_activity | binding_selection | business_activity_anchor | supported | src/pages/forms/1601-c.native:7 and legacy form_1601c.rs:225-246 | — |
| 0619F 2018-01-ENCS | `business_activity_anchor_id` | business_activity_anchor_id | filer | conditional | effective_business_activity | binding_selection | business_activity_anchor | evidence_required | Legacy form_0619f.rs:257-280 projects line of business; the Native inherited header now preserves that source-backed field | Reconcile the exact official 0619F header before enabling this activity binding |
...
| 1701Q 2018-01-ENCS | `business_activity_anchor_id` | business_activity_anchor_id | filer | conditional | effective_business_activity | binding_selection | business_activity_anchor | supported | Legacy form_1701q.rs:573-577 and 613 select the filer's recognized activity ATC and line of business | — |
| 1701Q 2018-01-ENCS | `spouse_business_activity_anchor_id` | business_activity_anchor_id | spouse | conditional | effective_business_activity | binding_selection | business_activity_anchor | evidence_required | Ownership matrix limits spouse activity binding to official-evidence approval | Confirm whether the exact 1701Q revision needs a stable spouse activity binding |
...
| 1701 2018-01-ENCS | `business_activity_anchor_id` | business_activity_anchor_id | filer | conditional | effective_business_activity | binding_selection | business_activity_anchor | supported | Legacy form_1701.rs:495-503 selects the filer's recognized activity ATC before deriving taxpayer type | — |
| 1701 2018-01-ENCS | `spouse_business_activity_anchor_id` | business_activity_anchor_id | spouse | conditional | effective_business_activity | binding_selection | business_activity_anchor | evidence_required | Ownership matrix limits spouse activity binding to official-evidence approval | Confirm whether the exact 1701 revision needs a stable spouse activity binding |
| 1702RT 2018-01-ENCS | `business_activity_anchor_id` | business_activity_anchor_id | filer | conditional | effective_business_activity | binding_selection | business_activity_anchor | supported | src/pages/forms/1702-rt.native:10 declares line of business | — |
| 1702MX 2018-01-ENCS | `business_activity_anchor_id` | business_activity_anchor_id | filer | conditional | effective_business_activity | binding_selection | business_activity_anchor | supported | src/pages/forms/1702-mx.native:10 declares line of business | — |
| 1702MX 2018-01-ENCS | `special_rate_obligation_anchor_id` | registration_obligation_anchor_id | filer | conditional | effective_registration_obligation | binding_selection | registration_obligation_anchor | evidence_required | src/pages/forms/1702-mx.native:11 has an optional special/preferential-rate basis | Confirm that the exact 1702MX revision permits multiple effective special-rate obligations before requiring a selector |
| 0619E 2018-01-ENCS | `business_activity_anchor_id` | business_activity_anchor_id | filer | conditional | effective_business_activity | binding_selection | business_activity_anchor | evidence_required | Legacy form_0619e.rs:254-279 projects line of business; the Native inherited header now preserves that source-backed field | Reconcile the exact official 0619E header before enabling this activity binding |
...
| `0605.1999-07-ENCS.input.line_of_business_occupation` | 12 Line of Business / Occupation | transaction | — | — | — | — | business_activity.line_of_business | filing | text | unbound_input | `src/pages/forms/0605.native:16` |
...
Tax Form Profile: `setup`, spec revision 1, SHA-256 `179583271c63f97aec9c68ded56403efd5236fa6103641c8fc6a96e1cf64b3c7`
...
Tax Form Profile: `setup`, spec revision 1, SHA-256 `93ab4ef44d1e44b712de233088c94eba8e37bf6f282ffff6621ab34e1869edb4`
...
Tax Form Profile: `setup`, spec revision 2, SHA-256 `3b4d5c84fe96cb99cb422b4d98554359ccd45ea64ba2ae5cdd21c7325cb00abf`
...
Tax Form Profile: `setup`, spec revision 2, SHA-256 `1bb153eff6506090b118fc67e6fd23e8d63d8d654cb147fe0a43b7926b3f7b16`
...
Tax Form Profile: `setup`, spec revision 1, SHA-256 `02592c75d72d118e68baac2e5be1d3d43deacad0f6eaa27f8ad390e6cc03c382`
...
Tax Form Profile: `setup`, spec revision 1, SHA-256 `28d601fbdc840c0d6aa8768f0ae00b69288e4ae96aca9d4c496fab5b00730936`
...
| `1702MX.2018-01-ENCS.input.special_preferential_rate_basis` | Special / Preferential Rate Basis | profile | special_rate_basis | optional | — | — | — | filer | text | unbound_input | `src/pages/forms/1702-mx.native:14` |
...
| `2550Q.2024-04-ENCS.input.vatable_sales_receipts` | 31A Vatable Sales / Receipts | transaction | — | — | — | — | — | filing | money | unbound_input | `src/pages/forms/2550q.native:21` |
| `2550Q.2024-04-ENCS.input.output_tax_due` | 31B Output Tax Due | derived | — | — | — | — | — | system | money | unbound_input | `src/pages/forms/2550q.native:22` |
| `2550Q.2024-04-ENCS.input.zero_rated_sales_receipts` | 32A Zero-Rated Sales / Receipts | transaction | — | — | — | — | — | filing | money | unbound_input | `src/pages/forms/2550q.native:23` |
| `2550Q.2024-04-ENCS.input.exempt_sales_receipts` | 33A Exempt Sales / Receipts | transaction | — | — | — | — | — | filing | money | unbound_input | `src/pages/forms/2550q.native:24` |
| `2550Q.2024-04-ENCS.input.output_vat_adjustments` | Output VAT Adjustments | transaction | — | — | — | — | — | filing | money | unbound_input | `src/pages/forms/2550q.native:25` |
| `2550Q.2024-04-ENCS.input.total_output_tax_due` | Total Output Tax Due | derived | — | — | — | — | — | system | money | unbound_input | `src/pages/forms/2550q.native:26` |
| `2550Q.2024-04-ENCS.input.domestic_purchases_input_tax` | 44 Domestic Purchases / Input Tax | transaction | — | — | — | — | — | filing | money | unbound_input | `src/pages/forms/2550q.native:32` |
| `2550Q.2024-04-ENCS.input.services_rendered_by_non_residents` | 45 Services Rendered by Non-Residents | transaction | — | — | — | — | — | filing | money | unbound_input | `src/pages/forms/2550q.native:33` |
| `2550Q.2024-04-ENCS.input.importation_of_goods` | 46 Importation of Goods | transaction | — | — | — | — | — | filing | money | unbound_input | `src/pages/forms/2550q.native:34` |
| `2550Q.2024-04-ENCS.input.other_purchases` | 47 Other Purchases | transaction | — | — | — | — | — | filing | money | unbound_input | `src/pages/forms/2550q.native:35` |
| `2550Q.2024-04-ENCS.input.domestic_purchases_without_input_tax` | 48 Domestic Purchases Without Input Tax | transaction | — | — | — | — | — | filing | money | unbound_input | `src/pages/forms/2550q.native:36` |
| `2550Q.2024-04-ENCS.input.exempt_importations` | 49 Exempt Importations | transaction | — | — | — | — | — | filing | money | unbound_input | `src/pages/forms/2550q.native:37` |
| `2550Q.2024-04-ENCS.input.input_tax_directly_attributable_to_exempt_sales` | Input Tax Directly Attributable to Exempt Sales | transaction | — | — | — | — | — | filing | money | unbound_input | `src/pages/forms/2550q.native:43` |
| `2550Q.2024-04-ENCS.input.input_tax_not_directly_attributable` | Input Tax Not Directly Attributable | transaction | — | — | — | — | — | filing | money | unbound_input | `src/pages/forms/2550q.native:44` |
| `2550Q.2024-04-ENCS.input.ratable_input_tax_to_exempt_sales` | Ratable Input Tax to Exempt Sales | derived | — | — | — | — | — | system | money | unbound_input | `src/pages/forms/2550q.native:45` |
| `2550Q.2024-04-ENCS.input.prior_return_payment` | Prior Return Payment | external | — | — | — | — | — | evidence | money | unbound_input | `src/pages/forms/2550q.native:51` |
| `2550Q.2024-04-ENCS.input.other_tax_credit_payment` | Other Tax Credit / Payment | transaction | — | — | — | — | — | filing | money | unbound_input | `src/pages/forms/2550q.native:52` |
| `2550Q.2024-04-ENCS.input.net_vat_payable_overpayment` | Net VAT Payable / (Overpayment) | derived | — | — | — | — | — | system | money | unbound_input | `src/pages/forms/2550q.native:53` |
| `2550Q.2024-04-ENCS.input.surcharge` | Surcharge | derived | — | — | — | — | — | system | money | unbound_input | `src/pages/forms/2550q.native:54` |
| `2550Q.2024-04-ENCS.input.interest` | Interest | derived | — | — | — | — | — | system | money | unbound_input | `src/pages/forms/2550q.native:55` |
| `2550Q.2024-04-ENCS.input.compromise` | Compromise | derived | — | — | — | — | — | system | money | unbound_input | `src/pages/forms/2550q.native:56` |
| `2550Q.2024-04-ENCS.input.taxpayer_authorized_representative` | Taxpayer / Authorized Representative | transaction | — | — | — | — | — | preparer | text | unbound_input | `src/pages/forms/2550q.native:62` |
| `2550Q.2024-04-ENCS.input.payment_method` | Payment Method | transaction | — | — | — | — | — | payment | choice | unbound_input | `src/pages/forms/2550q.native:63` |
| `2550Q.2024-04-ENCS.input.payment_reference` | Payment Reference | external | — | — | — | — | — | payment | text | unbound_input | `src/pages/forms/2550q.native:64` |
...
Tax Form Profile: `no_setup`, spec revision 1, SHA-256 `d87f1c08a0bc104cf70d4e90cba96b155af614c75ad2a1bcb6be0803fa322eec`

Consumed taxpayer-year settings: `income_tax_rate_election`
...
| `2551Q.2018-01-ENCS.input.registered_address` | Registered Address | profile | registered_address | required | — | — | — | filer | text | unbound_input | `src/pages/forms/2551q.native:86` |
| `2551Q.2018-01-ENCS.input.zip_code` | ZIP Code | profile | zip_code | required | — | — | — | filer | postal_code | unbound_input | `src/pages/forms/2551q.native:90` |
| `2551Q.2018-01-ENCS.input.contact_number` | Contact Number | profile | contact_number | required | — | — | — | filer | phone | unbound_input | `src/pages/forms/2551q.native:94` |
| `2551Q.2018-01-ENCS.input.email_address` | Email Address | profile | email_address | required | — | — | — | filer | email | unbound_input | `src/pages/forms/2551q.native:98` |
| `2551Q.2018-01-ENCS.input.schedule_1_line_1_percentage_tax_code` | Schedule 1 Line 1 Percentage-tax Code | transaction | — | — | — | — | — | filing | atc_code | unbound_input | `src/pages/forms/2551q.native:119` |
| `2551Q.2018-01-ENCS.input.schedule_1_line_1_tax_base_taxable_amount` | Schedule 1 Line 1 Tax Base / Taxable Amount | transaction | — | — | — | — | — | filing | money | unbound_input | `src/pages/forms/2551q.native:127` |
| `2551Q.2018-01-ENCS.input.schedule_1_line_1_policy_supplied_tax_rate` | Schedule 1 Line 1 Policy-supplied Tax Rate | external | — | — | — | — | — | evidence | percent | unbound_input | `src/pages/forms/2551q.native:135` |
| `2551Q.2018-01-ENCS.input.schedule_1_line_1_percentage_tax_due` | Schedule 1 Line 1 Percentage Tax Due | derived | — | — | — | — | — | system | money | unbound_input | `src/pages/forms/2551q.native:141` |
| `2551Q.2018-01-ENCS.input.schedule_1_line_2_percentage_tax_code` | Schedule 1 Line 2 Percentage-tax Code | transaction | — | — | — | — | — | filing | atc_code | unbound_input | `src/pages/forms/2551q.native:144` |
| `2551Q.2018-01-ENCS.input.schedule_1_line_2_tax_base_taxable_amount` | Schedule 1 Line 2 Tax Base / Taxable Amount | transaction | — | — | — | — | — | filing | money | unbound_input | `src/pages/forms/2551q.native:152` |
| `2551Q.2018-01-ENCS.input.schedule_1_line_2_policy_supplied_tax_rate` | Schedule 1 Line 2 Policy-supplied Tax Rate | external | — | — | — | — | — | evidence | percent | unbound_input | `src/pages/forms/2551q.native:160` |
| `2551Q.2018-01-ENCS.input.schedule_1_line_2_percentage_tax_due` | Schedule 1 Line 2 Percentage Tax Due | derived | — | — | — | — | — | system | money | unbound_input | `src/pages/forms/2551q.native:166` |
| `2551Q.2018-01-ENCS.input.total_percentage_tax_due` | 14 Total Percentage Tax Due | derived | — | — | — | — | — | system | money | unbound_input | `src/pages/forms/2551q.native:173` |
| `2551Q.2018-01-ENCS.input.creditable_percentage_tax_withheld` | 15 Creditable Percentage Tax Withheld | external | — | — | — | — | — | evidence | money | unbound_input | `src/pages/forms/2551q.native:176` |
| `2551Q.2018-01-ENCS.input.tax_paid_in_previous_return` | 16 Tax Paid in Previous Return | external | — | — | — | — | — | evidence | money | unbound_input | `src/pages/forms/2551q.native:184` |
| `2551Q.2018-01-ENCS.input.other_tax_credit_payment` | 17 Other Tax Credit / Payment | transaction | — | — | — | — | — | filing | money | unbound_input | `src/pages/forms/2551q.native:192` |
| `2551Q.2018-01-ENCS.input.total_tax_credits_payments` | 18 Total Tax Credits / Payments | derived | — | — | — | — | — | system | money | unbound_input | `src/pages/forms/2551q.native:198` |
| `2551Q.2018-01-ENCS.input.tax_payable_overpayment` | 19 Tax Payable / (Overpayment) | derived | — | — | — | — | — | system | money | unbound_input | `src/pages/forms/2551q.native:199` |
| `2551Q.2018-01-ENCS.input.surcharge_manual` | 20 Surcharge (manual) | transaction | — | — | — | — | — | filing | money | unbound_input | `src/pages/forms/2551q.native:202` |
| `2551Q.2018-01-ENCS.input.interest_manual` | 21 Interest (manual) | transaction | — | — | — | — | — | filing | money | unbound_input | `src/pages/forms/2551q.native:210` |
| `2551Q.2018-01-ENCS.input.compromise_manual` | 22 Compromise (manual) | transaction | — | — | — | — | — | filing | money | unbound_input | `src/pages/forms/2551q.native:218` |
| `2551Q.2018-01-ENCS.input.overpayment_disposition` | 24 Overpayment Disposition | transaction | — | — | — | — | — | filing | choice | unbound_input | `src/pages/forms/2551q.native:226` |
...
Tax Form Profile: `setup`, spec revision 1, SHA-256 `ed15f9eb1fdfa15af53d594adc4ad406d6d9a546f259b817066b91c1eb32cc0f`
...
| `0619E.2018-01-ENCS.input.government_withholding_agent` | 12 Government withholding agent? | profile | government_withholding_agent | required | — | — | — | filer | boolean | unbound_input | `src/pages/forms/0619-e.native:17` |
