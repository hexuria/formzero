...
if (!uiAppTests.includes("text-entry on-blur dispatches on Tab and pointer focus transitions")) {
  ...
  const blurAnchor = 'test "an open combobox enters its menu on Tab without dismissing" {';
...
`;
  const commandDeleteAnchor = 'test "an open combobox enters its menu on Tab without dismissing" {';
